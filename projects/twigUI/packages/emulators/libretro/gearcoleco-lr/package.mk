...
PKG_VERSION="aa8a104cecde65f5c285a7ce7895cc8546d43573"
PKG_LICENSE="GPL"
...
makeinstall_target() {
  ${STRIP} "${PKG_BUILD}"/platforms/libretro/gearcoleco_libretro.so
  cp "${PKG_BUILD}"/platforms/libretro/gearcoleco_libretro.{so,info} "${PKG_BUILD}"/
}
