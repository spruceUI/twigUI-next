...
VERSION_FILE = f"{SD_ROOT}/spruce/twig"
...
def main():
    ...
    log.info(f"Firmware: {read_sysfs('/etc/release', 'unknown')}")
    ...
    # Version comparison
    update_version_str = re.search(r"twigUI_V([\d.]+)", update_file)
